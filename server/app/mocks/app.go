...
func (m *MockProductInterface) GetDescription() string {
	m.ctrl.T.Helper()
...
func (mr *MockProductInterfaceMockRecorder) GetDescription() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDescription", reflect.TypeOf((*MockProductInterface)(nil).GetDescription))
}
...
func (m *MockProductServiceInterface) CreateProduct(name, description string, price int64) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateProduct", name, description, price)
...
func (mr *MockProductServiceInterfaceMockRecorder) CreateProduct(name, description, price interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateProduct", reflect.TypeOf((*MockProductServiceInterface)(nil).CreateProduct), name, description, price)
}

// DisableProduct mocks base method.
func (m *MockProductServiceInterface) DisableProduct(Product app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DisableProduct", Product)
	ret0, _ := ret[0].(app.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductServiceInterfaceMockRecorder) DisableProduct(Product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DisableProduct", reflect.TypeOf((*MockProductServiceInterface)(nil).DisableProduct), Product)
}

// EnableProduct mocks base method.
func (m *MockProductServiceInterface) EnableProduct(Product app.ProductInterface) (app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "EnableProduct", Product)
	ret0, _ := ret[0].(app.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductServiceInterfaceMockRecorder) EnableProduct(Product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EnableProduct", reflect.TypeOf((*MockProductServiceInterface)(nil).EnableProduct), Product)
}
...
func (m *MockProductServiceInterface) GetAll() ([]app.ProductInterface, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockProductReaderInterface) GetAll() ([]app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].([]app.ProductInterface)
	ret1, _ := ret[1].(error)
...
// GetAll indicates an expected call of GetAll.
func (mr *MockProductReaderInterfaceMockRecorder) GetAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockProductReaderInterface)(nil).GetAll))
}
...
// GetAll mocks base method.
func (m *MockProductPersistenceInterface) GetAll() ([]app.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll")
	ret0, _ := ret[0].([]app.ProductInterface)
	ret1, _ := ret[1].(error)
